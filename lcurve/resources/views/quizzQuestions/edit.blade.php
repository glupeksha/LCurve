...
@section('dash-left')
    ...
    {{ Form::model($quizzQuestion, array('route' => array('quizzQuestions.update', $quizzQuestion->id), 'method' => 'PUT')) }}
    ...
    {!! Form::submit(trans('quizzQuestions.update'), ['class' => 'btn btn-danger']) !!}
    {!! Form::close() !!}
@endsection